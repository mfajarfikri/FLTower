    ...
    <div class="bg-gray-100  text-gray-600 h-screen flex overflow-hidden text-sm">
        <div class="bg-white  w-20 flex-shrink-0 border-r border-gray-200 flex-col hidden sm:flex">
            ...
            <div class="flex mx-auto flex-grow mt-4 flex-col text-gray-400 space-y-4">
                <button class="h-10 w-12 rounded-md flex items-center justify-center bg-blue-100 text-blue-500">
            ...
            <div class="flex-grow flex overflow-x-hidden">
                <div class="xl:w-72 w-48 flex-shrink-0 border-r border-gray-200 h-full overflow-y-auto lg:block hidden p-5">
                    ...
                    <div class="relative mt-2">
                        <input type="text"
                            class="pl-8 h-9 bg-transparent border border-gray-300  w-full rounded-md text-sm"
                            placeholder="Search" />
                ...
                <div class="flex-grow bg-white  overflow-y-auto">
                    <div
                        class="sm:px-7 sm:pt-7 px-4 pt-4 flex flex-col w-full border-b border-gray-200 bg-white  sticky top-0">
                        <div class="flex w-full items-center">
                            ...
                            <div class="ml-auto sm:flex hidden items-center justify-end">
                                <div class="text-right">
                                    ...
                                    <div class="text-gray-900 text-lg">$2,794.00</div>
                                </div>
                                <button
                                    class="w-8 h-8 ml-4 text-gray-400 shadow  rounded-full flex items-center justify-center border border-gray-200 ">
                        ...
                        <div class="flex items-center space-x-3 sm:mt-7 mt-4">
                            ...
                            <a href="#"
                                class="px-3 border-b-2 border-transparent text-gray-600  pb-1.5">Transfer</a>
                            <a href="#"
                    ...
                    <div class="sm:p-7 p-4">
                        <div class="flex w-full items-center mb-7">
                            <button
                                class="inline-flex mr-3 items-center h-8 pl-2.5 pr-2 rounded-md shadow text-gray-700  border border-gray-200 leading-none py-0">
                                <svg viewBox="0 0 24 24" class="w-4 mr-2 text-gray-400 " stroke="currentColor"
                                ...
                                Last 30 days
                                <svg viewBox="0 0 24 24" class="w-4 ml-1.5 text-gray-400 " stroke="currentColor"
                                    stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <polyline points="6 9 12 15 18 9"></polyline>
                                </svg>
                            </button>
                            <button
                                class="inline-flex items-center h-8 pl-2.5 pr-2 rounded-md shadow text-gray-700  border border-gray-200 leading-none py-0">
                                Filter by
                                <svg viewBox="0 0 24 24" class="w-4 ml-1.5 text-gray-400 " stroke="currentColor"
                                    stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <polyline points="6 9 12 15 18 9"></polyline>
                            ...
                            <div class="ml-auto text-gray-500 text-xs sm:inline-flex hidden items-center">
                                ...
                                <button
                                    class="inline-flex mr-2 items-center h-8 w-8 justify-center text-gray-400 rounded-md shadow border border-gray-200 leading-none py-0">
                                ...
                                <button
                                    class="inline-flex items-center h-8 w-8 justify-center text-gray-400 rounded-md shadow border border-gray-200 leading-none py-0">
                                    <svg class="w-4" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"
                                        fill="none" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <table class="w-full text-left">
                            <thead>
                                <tr class="text-gray-400">
                                    ...
                                    <th class="font-normal px-3 pt-0 pb-3 border-b border-gray-200">
                                        Amount</th>
                                    <th
                                        class="font-normal px-3 pt-0 pb-3 border-b border-gray-200 sm:text-gray-400 text-white">
                                        Date</th>
                                </tr>
                            </thead>
                            <tbody class="text-gray-600 ">
                                ...
                                <tr>
                                    ...
                                    <td class="sm:p-3 py-2 px-1 border-b border-gray-200">
                                        <div class="flex items-center">
                                            <img class="w-7 h-7 mr-2.5 border border-gray-200 rounded-full"
                                                src="https://images.unsplash.com/photo-1521587765099-8835e7201186?ixlib=rb-1.2.1&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&ixid=eyJhcHBfaWQiOjE3Nzg0fQ"
                                                alt="profile" />
                                            James Smith
                                        </div>
